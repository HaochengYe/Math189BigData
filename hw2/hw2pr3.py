...
In order to complete this assignment, I referred the solution posted online extensively.
Despite the great similarity between my code and the solution, 
I have learned the meaning behind each line of code and thus familiarized myself with pandas and numpy
...
def RMSE_vs_lambda(X_train, y_train, X_val, y_val):
	...
	"*** YOUR CODE HERE ***"
	opt_lambda = np.argmin(RMSE_list)
	reg_opt = reg_list[opt_lambda]
